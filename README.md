...
* [OpenVM](https://github.com/openvm-org/openvm) ⭐ 392 | 🐛 11 | 🌐 Rust | 📅 2026-09-18 - Modular zkVM framework used by Scroll's prover.
* [Scroll zkVM Prover](https://github.com/scroll-tech/zkvm-prover) ⭐ 33 | 🐛 11 | 🌐 Rust | 📅 2026-09-22 - Guest programs and prover SDK for Scroll's OpenVM-based proving architecture.
